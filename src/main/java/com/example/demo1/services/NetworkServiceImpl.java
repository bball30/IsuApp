...
@Stateless
public class NetworkServiceImpl implements com.example.demo1.services.NetworkService {

    private final String STUDY_GROUP_SERVICE = "https://localhost:8181/StudyGroupApp/api";
